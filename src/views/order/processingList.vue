    ...
    <el-table
      ...
      <el-table-column align="center" label="操作">
        <template slot-scope="scope">
          ...
          <el-tooltip class="item" effect="dark" content="加工完成" placement="bottom">
            <a class="el-icon-success" style="margin-right:10px" @click="pass(scope.row.orderNo)"/>
          </el-tooltip>
        </template>
      </el-table-column>
    </el-table>
    ...
    pass(orderNo) {
      this.$confirm('是否确认加工完成', '提示', {
        ...
        .then(() => {
          ...
          api.processComplete(params).then(response => {
            this.fetchData()
          })
          this.$message({
            type: 'success',
